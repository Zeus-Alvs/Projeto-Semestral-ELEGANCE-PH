...
<div class="agrupo">
  <div class="logos">
    <img src="Imagens/ICON NIKE.png" alt="Nike">
    <img src="Imagens/ICON ADIDAS.png" alt="Adidas">
    <img src="Imagens/ICON HUGO BOSS.png" alt="Hugo Boss">
    <img src="Imagens/ICON MIZUNO.png" alt="Mizuno">
    <img src="Imagens/ICON PUMA.png" alt="Puma">
  </div>
</div>

<!-- mais vendidos animacao -->

<section class="secao-mais-vendidos">
  <h2 class="titulo-mv">MAIS VENDIDOS</h2>

    <div class="slider">
        <div class="slide-track">

<?php
$query = $pdo->query('SELECT nome,id,foto,preco FROM produto order by vendidos desc limit 5');
...
if (isset($_SESSION['usuario_id']) && $_SESSION['nivel'] === 'admin') {
    ...
    foreach ($produtos as $produto) {
      ...
      echo '
        <a href="EditarProdutos.php?id='.$produto['id'].'">  
